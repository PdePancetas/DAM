...
public class EmpleadoController {
	...
	public String createEmpleado(String dni, String nom_emp, String id_depto) {
...
//			Empleado empleado = new Empleado(dni, nom_emp, id_depto);// Creamos un objeto empleado con los parámetros pasados
