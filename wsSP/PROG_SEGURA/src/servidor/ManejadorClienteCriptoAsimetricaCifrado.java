...
class ManejadorClienteCriptoAsimetricaCifrado implements Runnable {
	private Socket socket;
	private DataOutputStream dos;
	private DataInputStream dis;

	public ManejadorClienteCriptoAsimetricaCifrado(Socket socket) throws IOException {
		this.socket = socket;
	...
	public void run() {
		...
		try {
			...
			String mensaje = recibirMensaje(dis, claves);
			System.out.println("Mensaje descifrado: " + mensaje);

			enviarMensaje(dos, clavePublicaCliente, "Mensaje CIFRADO de servidor a cliente");
	...
	public static void enviarMensaje(DataOutputStream dos, PublicKey publicKeyRec, String mensaje)
			throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException,
			IllegalBlockSizeException, BadPaddingException {

		Cipher c = Cipher.getInstance("RSA");
		c.init(Cipher.ENCRYPT_MODE, publicKeyRec);
	...
	public static String recibirMensaje(DataInputStream dis, KeyPair claves)
			throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException,
			IllegalBlockSizeException, BadPaddingException {
