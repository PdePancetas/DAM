...
class MainActivityV2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val frgImagenes = supportFragmentManager.findFragmentById(R.id.fragment_image_v2) as FragmentImagenesV2
        frgImagenes.setImageListener {
            var frgDetalle: Fragment? =
                supportFragmentManager.findFragmentById(R.id.fragmentContainerViewHorz) as? FragmentTextoV2
